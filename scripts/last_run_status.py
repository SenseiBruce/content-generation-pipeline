#!/usr/bin/env python3
"""Print the status of the most recent pipeline run."""
...
def last_run_status(payload: dict[str, Any]) -> dict[str, Any]:
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Print last pipeline run status")
    parser.add_argument(
        "--state-file",
    ...
    if not isinstance(payload, dict):
        ...
        return 1
    print(json.dumps(last_run_status(payload)))
    return 0
