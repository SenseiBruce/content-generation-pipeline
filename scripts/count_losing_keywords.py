#!/usr/bin/env python3
"""Count losing keywords in data/analytics_feedback.json."""
...
def count_losing_keywords(payload: dict[str, Any]) -> int:
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Count losing keywords")
    parser.add_argument(
        "--feedback-file",
    ...
    if not isinstance(payload, dict):
        ...
        return 1
    print(json.dumps({"losing_keywords": count_losing_keywords(payload)}))
    return 0
