...
# Recent recorded runs (JSON)
python3 scripts/list_runs.py --limit 10
```
...
python3 scripts/list_seen.py
```

`list_seen.py` prints `{"seen_hashes": [...]}` from `data/pipeline_state.json`.
python3 scripts/count_runs.py
```
